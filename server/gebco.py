...
def get_bathymetry(
    ...
    if is_live_api:
        ...
        provenance = {
            ...
            "is_synthetic": True,
            "warning": (
                "Live GEBCO data was unavailable. "
                "Bathymetry shown here is generated by the local synthetic "
                "fallback model and must not be treated as GEBCO data."
            ),
        }
